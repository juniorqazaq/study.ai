...
import { signup, googleLogin } from "@/shared/api/endpoints/auth.api";
...
export function Register() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            saveAuthTokens(accessToken, refreshToken, { ...parsed, fullName });
            window.scrollTo(0, 0);
            navigate('/library');
        } catch (err) {
    ...
    return (
        <div className="min-h-screen w-full bg-[#000000] text-[#F5F5F5] font-sans flex flex-col justify-center items-center p-4 relative overflow-hidden selection:bg-[#0066FF]/20 selection:text-[#0066FF]">
            ...
            <motion.div
                ...
                className="w-full max-w-[460px] bg-[#141414] border border-white/[0.08] rounded-[2rem] p-8 md:p-10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.4)] relative z-10 backdrop-blur-xl"
            >
                {/* Logo / Header */}
                <div className="text-center mb-8">
                    ...
                    <p className="text-[1rem] font-normal text-[#888888] leading-relaxed">
                        Start learning smarter with custom AI sets today.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1.5">
                        <label htmlFor="fullName" className="text-sm font-medium text-[#888888]">
                            Full Name
                        </label>
                        <input
                            id="fullName"
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor="confirmPassword" className="text-sm font-medium text-[#888888]">
                            Confirm Password
                        </label>
                        <div className="relative">
                            <input
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full h-12 mt-4 rounded-full bg-gradient-to-r from-[#0066FF] to-[#3B82F6] hover:opacity-90 active:scale-[0.98] transition-all duration-200 text-white font-medium text-[0.9375rem] flex items-center justify-center disabled:opacity-50 disabled:pointer-events-none"
                    >
                        {isLoading ? (
                ...
                <div className="mt-8 text-center text-sm font-normal text-[#888888]">
                    ...
                    <Link to="/login" className="font-medium text-[#0066FF] hover:opacity-80 transition-opacity">
                        Log in
                    </Link>
                </div>
            </motion.div>
